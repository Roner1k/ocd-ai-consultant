...
class Shortcodes
{
    ...
    /**
     * Renders the AI Chat interface for users.
     */
    public static function renderChat($atts = [], $content = null)
    {
        ...
        $has_active_subscription = true; // пока всегда true

        $chat_status = 'ready'; // по умолчанию
        $model_info = [
            'status' => '',
            'model_id' => '',
            'chat_language' => 'en',
        ...
        ", $current_user->ID));
            ...
            if (!$model) {
                ...
                $model_info = [
                    ...
                    'chat_language' => $model->chat_language ?: 'en',
                    'last_trained_at' => $model->last_trained_at,
                ];

                if ($model->status !== 'ready') {
                    $chat_status = 'training';
                }
            }
        }
